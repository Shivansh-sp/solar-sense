...
const API_CONFIG = {
  ...
  production: {
    baseURL: process.env.NEXT_PUBLIC_API_URL || 'https://solarsense-backend.onrender.com',
    timeout: 15000,
  },
  staging: {
    baseURL: process.env.NEXT_PUBLIC_API_URL || 'https://solarsense-backend-staging.onrender.com',
    timeout: 15000,
  }
}
